...
import (
	...
	"gorm.io/gorm"
	_ "yt-otel-tracing/docs"
	"yt-otel-tracing/src/application/controller"
	"yt-otel-tracing/src/application/domain/persistance"
	"yt-otel-tracing/src/application/domain/services"
	"yt-otel-tracing/src/infra/middleware"
	"yt-otel-tracing/src/infra/trace"
	"yt-otel-tracing/src/infra/validation"
)
